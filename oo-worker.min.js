...
"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var d3_queue_1=require("d3-queue"),tinyqueue_1=__importDefault(require("tinyqueue")),Worker=function(){function e(){var e=this;this._tasks=new tinyqueue_1.default,this._queue=d3_queue_1.queue();for(var t=0;t<25;t+=1)this._tasks.push({data:t+1});for(var u=function(t){r._queue.defer(function(u){e._log(t),u(null)})},r=this,o=0,n=this._tasks.data;o<n.length;o++){u(n[o])}this._queue.awaitAll(function(t){e._log(t)})}return e.prototype._log=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];console.log.apply(console,["["+this.constructor.name+"]"].concat(e))},e}();exports.Worker=Worker;

},{"d3-queue":1,"tinyqueue":2}]},{},[3])(3)
});
