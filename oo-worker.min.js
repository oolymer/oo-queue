...
"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var tinyqueue_1=__importDefault(require("tinyqueue")),p_queue_1=__importDefault(require("p-queue")),Worker=function(){function e(e,t){this._name=e,this._options=t,this._running=!1,this._initTaskPriorityQueue(),this._initTaskProcessQueue()}return e.prototype._initTaskPriorityQueue=function(){this._tasks=new tinyqueue_1.default},e.prototype._initTaskProcessQueue=function(){this._queue=new p_queue_1.default({concurrency:1,autoStart:!1})},e.prototype.enqueueTask=function(e){this._tasks.push(e)},e.prototype.dequeueTasks=function(e){void 0===e&&(e=1);for(var t=[];e>0&&this._tasks.length>0;)t.push(this._tasks.pop()),e-=1;return t},e.prototype.prepareBatch=function(e){void 0===e&&(e=10);for(var t=0,u=this.dequeueTasks(e);t<u.length;t++){u[t];this._queue.add(function(){return Promise.resolve()})}return this._queue},e.prototype.processBatch=function(){this._queue.start(),this._queue.onIdle().then(function(){})},e.prototype._log=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];console.log.apply(console,["["+this.constructor.name+"]"].concat(e))},e}();function _require(e,t){if(!e){if(t)throw t();throw"illegal argument"}}function _requireNotNil(e,t){if(_isNil(e)){if(t)throw t();throw"illegal argument"}}function _isNil(e){return null===e||void 0===e}exports.Worker=Worker;
